(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~src-app-modules-admin-admin-module~src-app-modules-ceremony-ceremony-module"],{
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tslib */ "mAIw");
...
/***/ "JJL8":
/*!**********************************************!*\
  !*** ./src/app/services/ceremony.service.ts ***!
  \**********************************************/
/*! exports provided: CeremonyService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CeremonyService", function() { return CeremonyService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "qCKp");
...
class CeremonyService {
    ...
    emmiterShowCreateCeremony(val) {
        this.showCreateCeremony$.next(val);
    }
    getSubjetShowCreateCeremony() {
    ...
    getSubjetShowCreateReservation() {
...
CeremonyService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: CeremonyService, factory: CeremonyService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CeremonyService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
class PlaceService {
    constructor(firestore) {
        this.firestore = firestore;
        this.showEditReservation$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
    }
    // Mostrar u ocultar crear ceremony
    emmiterShowEditPlace(val) {
        this.showEditReservation$.next(val);
    }
    getSubjetShowEditPlace() {
        return this.showEditReservation$;
    }
    createReservation(ceremonyId, place) {
        var key = place.id;
        delete place.id;
        return this.firestore.doc(`ceremonies/${ceremonyId}/places/${key}`).update(place);
    }
}
PlaceService.ɵfac = function PlaceService_Factory(t) { return new (t || PlaceService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"])); };
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ "mAIw");
...
//# sourceMappingURL=default~src-app-modules-admin-admin-module~src-app-modules-ceremony-ceremony-module.js.map